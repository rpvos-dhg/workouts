...
export const DEFAULT_USER_SETTINGS = {
  ...
  heart_zones: [
    { zone: 'Z1', min: 105, max: 120 },
    { zone: 'Z2', min: 120, max: 135 },
    { zone: 'Z3', min: 135, max: 150 },
    { zone: 'Z4', min: 150, max: 165 },
    { zone: 'Z5', min: 165, max: 186 },
  ],
};
...
export function calculateTrendStats({ logs = [], checkins = [], completed = {}, planData = PLAN_DATA } = {}) {
  ...
  const weekProgress = [...new Set(planData.map(day => day.week))].map(week => {
  ...
  return {
    ...
    hrv: trend(checkins, 'hrv'),
    energy: trend(checkins, 'energy_level'),
    mood: trend(checkins, 'mood_level'),
