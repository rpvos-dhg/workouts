...
export const MEASUREMENT_MOMENTS = [
  ...
  },
  {
    ...
    items: ['Gewicht of 7-daags gemiddelde', 'Buikomtrek', 'Slaap en rusthartslag', 'Energie, honger, spierpijn en stemming'],
  },
  {
    key: 'taper',
    week: 5,
...
export const PRACTICAL_TIPS = [
  ...
  { title: 'Wegen en meten', items: ['Meet alleen op de geplande meetmomenten in de Check-in tab.', 'Gebruik steeds hetzelfde moment: na wc en voor ontbijt.', 'Buikomtrek bij de navel, ontspannen uitademen.', 'Foto op start, taper en eindmeting als reminder.'] },
];
