...
export const STRENGTH_GUIDE = {
  ...
  B: [
    ...
    },
    {
      ...
      rest: '60 sec',
      notes: 'Wk 1-2 op knieen, wk 3+ op tenen. Heup zo stil mogelijk.',
      guideSource: 'ACE',
      guideUrl: 'https://www.acefitness.org/resources/everyone/exercise-library/195/shoulder-tap/',
      steps: [
        'Neem een hoge plankpositie met handen onder de schouders.',
        'Span je buik en billen aan zodat heupen niveau blijven.',
        'Tik rustig je linker schouder aan met je rechterhand.',
        'Zet de hand terug en wissel; vermijd dat je heupen schommelen.',
      ],
    },
    {
      name: 'Superman / Y-T-W',
